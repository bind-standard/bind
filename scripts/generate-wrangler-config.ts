  ...
  switch (context) {
    case "production":
      return {
        ...
        name: "bind-standard",
        routes: [
          { pattern: "bind-standard.org", custom_domain: true },
          { pattern: "www.bind-standard.org", custom_domain: true },
        ],
      };
    ...
    case "pr-preview": {
      ...
      return {
        ...base,
        name: `bind-standard-pr-${prNumber}`,
        routes: [
          {
...
const content = `// Auto-generated by scripts/generate-wrangler-config.ts — do not edit manually
